...
public class DefectBriefReqAPI {
     ...
     * @return
     */
    @RequestMapping(value = "/getUserDefectList", method = RequestMethod.POST)
    private Map<String, Object> getUserDefectList(@RequestBody UserReq userReq) {
        Map<String, Object> modelMap = new HashMap<String, Object>();
        List<DefectBriefReq> list = new ArrayList<DefectBriefReq>();
        list = defectBriefReqService.getUserDefect(userReq);
        modelMap.put("userDefectList", list);
        return modelMap;
    }
}
